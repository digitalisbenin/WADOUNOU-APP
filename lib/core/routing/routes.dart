...
final Map<String, WidgetBuilder> routes = {
  ...
  SelectedRoleScreen.routeName: (context) => const SelectedRoleScreen(),
  ...
  RestaurantCreatedSuccessfully.routeName: (context) =>
      const RestaurantCreatedSuccessfully(),
  ...
  DeliveryPersonListviewPage.routeName: (context) {
    ...
    return DeliveryPersonListviewPage(
  ...
  DonedReservationViewPage.routeName: (context) =>
      const DonedReservationViewPage(),
  ...
  RegisterDeliveryPersonSuccess.routeName: (context) =>
      const RegisterDeliveryPersonSuccess(),
  AccountViewDeliveryPerson.routeName: (context) =>
      const AccountViewDeliveryPerson(),
  MakeReservationScreen.routeName: (context) => const MakeReservationScreen(),
  DeliveryPersonEditProfilePage.routeName: (context) =>
  ...
  AffiliateRestaurantPage.routeName: (context) =>
      const AffiliateRestaurantPage(),
  ...
  RestaurantsNewArrivalPages.routeName: (context) =>
      const RestaurantsNewArrivalPages(),
  RestaurantsOtherArrivalPages.routeName: (context) =>
      const RestaurantsOtherArrivalPages(),
  ...
  ProfilePage.routeName: (context) => const ProfileScreen(),
  LivreurScreen.routeName: (context) => const LivreurScreen(),
  AllOrdersScreen.routeName: (context) => const AllOrdersScreen(),
  AllBookingsScreen.routeName: (context) => const AllBookingsScreen(),
  AllDeliverScreens.routeName: (context) => const AllDeliverScreens(),
};
