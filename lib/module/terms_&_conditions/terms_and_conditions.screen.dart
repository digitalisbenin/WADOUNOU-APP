          ...
          child: Column(
            children: [
              ...
              RichText(
                text: const TextSpan(
                  style: TextStyle(
                      fontSize: 17, color: Colors.black), // Style par défaut
                  children: <TextSpan>[
                    TextSpan(
                      text:
                          'Veuillez lire attentivement ces termes et conditions avant d\'utiliser de l\' application Wadounnou.\n\n',
                      style: TextStyle(
                    ...
                    TextSpan(
                      ...
                      style: TextStyle(
                          ...
                          color: kPrimaryColor), // Titre bleu et gras
                    ),
                    TextSpan(
                      text:
                          'En accédant à l\'application ou en l\'utilisant, vous acceptez d\'être lié par ces termes et conditions. '
                          'Si vous n\'êtes pas d\'accord avec une partie des conditions, vous ne devez pas accéder à l\'application Wadounnou.\n\n',
                    ...
                    TextSpan(
                      text:
                          'Le contenu de l\'application Wadounnou, y compris les textes, images et tout autre matériel, est la propriété ou est sous licence du développeur de l\'application.\n\n',
                    ...
                    TextSpan(
                      text:
                          'Vous ne devez pas abuser de l\'application ou de son contenu. Cela inclut tout usage illégal ou interdit de l\'application. Il est explicitement demandé de ne pas faire un usage abusif ou illégal de l’application ou de son contenu. Cela pourrait inclure l’exploitation des fonctionnalités à des fins frauduleuses, le piratage, ou toute activité interdite. Cette clause rappelle à l’utilisateur qu’il à la responsabilité de ne pas violer les lois locales ou internationales en utilisant Wadounnou.\n\n',
                      style: TextStyle(color: Colors.black87),
                    ),
                    TextSpan(
                    ...
                    TextSpan(
                      text:
                          ...
                          'En utilisant l\'application Wadounnou, vous acceptez la collecte et l\'utilisation des informations conformément à notre politique de confidentialité.\n\n',
                      style: TextStyle(color: Colors.black87),
                    ),
                  ],
                ),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: isAcceptChecked
                      ? kPrimaryColor
