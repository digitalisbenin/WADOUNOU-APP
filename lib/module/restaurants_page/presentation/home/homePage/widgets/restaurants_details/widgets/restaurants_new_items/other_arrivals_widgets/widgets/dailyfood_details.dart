  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          centerTitle: true,
          title: Text(
            arguments.restaurant!.name.toString(),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: NetworkImage(arguments.repas.image_url ?? ''),
                      fit: BoxFit.fill)),
            ),
            /* Padding(
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        GestureDetector(
                                                                          onLongPress: () {
                                                                            Clipboard.setData(
                                                                                ClipboardData(text: arguments.restaurant!.mtnpay.toString()));
                                                                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                                                                                content: Text(
                                                                                    'Le code a été copié dans le presse-papier')));
                                                                          },
                                                                          child: SelectableText(
                                                                            arguments.restaurant!.mtnpay.toString(),
                                                                            style: TextStyle(
                                                                  ...
                                                                  if (arguments.restaurant!.moovpay == "")
                                                                    Row(
                                                                      children: [
                                                                    ...
                                                                    Row(
                                                                      children: [
                                                                        ...
                                                                        GestureDetector(
                                                                          onLongPress: () {
                                                                            Clipboard.setData(
                                                                                ClipboardData(text: arguments.restaurant!.moovpay.toString()));
                                                                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                                                                                content: Text(
                                                                                    'Le code a été copié dans le presse-papier')));
                                                                          },
                                                                          child: SelectableText(
                                                                            arguments.restaurant!.moovpay.toString(),
                                                                            style: TextStyle(
                                                                                fontSize: SizeConfig.screenHeight * 0.02,
                                                                                color: kPrimaryColor,
                                                                                fontWeight: FontWeight.bold),
                                                                  ...
                                                                  if (arguments.restaurant!.celtispay == "")
                                                                    Row(
                                                                      children: [
                                                                    ...
                                                                    Row(
                                                                      children: [
                                                                        ...
                                                                        GestureDetector(
                                                                          onLongPress: () {
                                                                            Clipboard.setData(
                                                                                ClipboardData(text: arguments.restaurant!.celtispay.toString()));
                                                                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                                                                                content: Text(
                                                                                    'Le code a été copié dans le presse-papier')));
                                                                          },
                                                                          child: SelectableText(
                                                                            arguments.restaurant!.celtispay.toString(),
                                                                            style: TextStyle(
                                                                                fontSize: SizeConfig.screenHeight * 0.02,
                                                                                color: kPrimaryColor,
                                                                                fontWeight: FontWeight.bold),
