...
class _DailySingleFoodCardState extends State<DailySingleFoodCard> {
  ...
  void addToCartFromRestaurant() {
    Provider.of<CartProvider>(context, listen: false)
        .addToCartFromRestaurant(widget.repas, context);
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(repas.image_url ?? ''),
                            fit: BoxFit.cover)),
                  ),
                  /* Container(
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      overflow: TextOverflow.ellipsis,
                      color: kYellowColor,
                      // Couleur que vous souhaitez utiliser
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                  /* SizedBox(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "${double.parse(repas.prix ?? '0').toStringAsFixed(0)} FCFA",
                        style: TextStyle(
